...
# Generated: Thu Oct 13 02:14:30 2016
##################################################
...
class hurdle2_solution_stub_autogenerated(gr.top_block):
    ...
    def __init__(self, hurdle2_IQ_port='9091', hurdle2_result_port=9090, hurdle2_scoring_host='127.0.0.1', num_bins=30, sample_filename='sample_filename.dat'):
        ...
        self.blocks_socket_pdu_0 = blocks.socket_pdu("TCP_CLIENT", hurdle2_scoring_host, hurdle2_IQ_port, 10000, False)
...
def argument_parser():
    ...
    parser.add_option(
        "", "--hurdle2-IQ-port", dest="hurdle2_IQ_port", type="string", default='9091',
