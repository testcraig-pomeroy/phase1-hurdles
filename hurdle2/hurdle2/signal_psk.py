...
class psk_tx(gr.hier_block2):
    ...
    def __init__(self, channel_shift_hz=0, random_source_seed=0, sample_rate=0, symbol_rate=1):
        ...
        # Connections
        ##################################################
        self.connect((self.analog_random_uniform_source_x_0, 0), (self.digital_psk_mod_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.blocks_multiply_xx_0, 1))
        self.connect((self.blocks_multiply_xx_0, 0), (self, 0))
        self.connect((self.digital_psk_mod_0, 0), (self.low_pass_filter_0_0, 0))
    ...
    def set_channel_shift_hz(self, channel_shift_hz):
        self.channel_shift_hz = channel_shift_hz
        self.analog_sig_source_x_0.set_frequency(self.channel_shift_hz)
    ...
    def set_sample_rate(self, sample_rate):
        ...
        # self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.sample_rate, 50000, 10000, firdes.WIN_HAMMING, 6.76))
