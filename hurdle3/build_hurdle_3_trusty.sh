...
LXC_NAME=hurdle3_scoring_trusty_lxc
SOLUTION_NAME=hurdle3_solution_trusty_lxc
LXC_PREFIX="$(pwd)"/lxc
...
$LXC_ATTACH_CMD apt-get install -y openssh-server python2.7 python-pip python-dev python-tk git python-thrift 
$LXC_ATTACH_CMD pip install --upgrade pip

$LXC_ATTACH_CMD pip install jupyter numpy matplotlib
